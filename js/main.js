...
let MyApp = {
  ...
  notationTwo: {
    firstname: "Bisi",
    lastname : "Lanre Friend"
  }
}

console.log(MyApp.notationOne[0].firstname);
console.log(MyApp.notationOne[0].lastname);

console.log(MyApp.notationTwo.firstname);
console.log(MyApp.notationTwo.lastname);
...
console.log(MyApp.notationOne[0].firstname[0].name1);
console.log(MyApp.notationOne[0].firstname[0].name2[0].nameThree);
console.log(MyApp.notationOne[0].firstname[0].name2[0].nameFour);


console.log(MyApp.notationTwo.secondfirstname.davidson[0].likeDoing)
console.log(MyApp.notationTwo.lastname);
